...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-xs-5">
                <div class="text-left text-muted">Mahmoud Test / Do1 / 20 Jul 2022 </div>
            </div>
            <div class="col-xs-5">
        ...
        <div class="row">
            ...
            <div class="col-xs-5">
                <h5 class="text-right text-muted">1</h5>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-xs-5">
                ...
                <div class="text-left text-muted">Mahmoud Test</div>
            </div>
            <div class="col-xs-5">
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-xs-5">
                <h5 class="text-right text-muted">02/07/2000</h5>
            </div>
        </div>
        <hr style="margin: 0; padding: 0;">
        <div class="row">
            ...
            <div class="col-xs-5">
                <h5 class="text-right text-muted">Syria - Damascuse - Kafrsusa </h5>
            </div>
        </div>
        <hr style="margin: 0; padding: 0;">
        <div class="row">
            ...
            <div class="col-xs-5" style="margin-left: 100px;">
                <h5 class="text-center text-muted" style="background-color:#4b804b; color:white; padding:10px ; margin-top: 0; margin-bottom: 2px; margin-left: 50px;">Just Passing By ;-)</h5>
            </div>
        </div>
        <hr style="margin: 0; padding: 0;">
        <div class="row">
        ...
        <div class="row">
            <div class="col-xs-10">
                <h5 class="text-left text-muted">The Note of level risk : Lorem ipsum dolor sit amet consectetur adipisicing elit. Inventore, itaque!</h5>
            </div>
        </div>
        <hr style="margin: 0; padding: 0;">
        <div class="row">
    ...
    <div class="container">
        <div class="row" style="background-color:#e6e6e6; padding:5px; margin-right: 0px; margin-left: 0px;">
            <div class="col-xs-10">
                <h4 class="text-center" style="margin-left: 50px;"><b>Fire Fighting System</b></h4>
            </div>
        ...
        <div class="row">
            <div class="col-xs-5">
                <h5 class="text-left">Electrical Pump</h5>
            </div>
            <div class="col-xs-5" style="margin-left: 100px;">
                <h5 class="text-center text-muted" style="background-color:#4b804b; color:white; padding:10px ; margin-top: 0; margin-bottom: 2px; margin-left: 50px;">متل الليرة</h5>
            </div>
        </div>
        <hr style="margin: 0; padding: 0;">
        <div class="row">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-xs-5">
                ...
                <div class="text-left text-muted">1-Fire alarm system working properly
                    2-Fire fighting system working properly
                    3-The fire pump under owner responsibility
                    </div>
            </div>
            <div class="col-xs-5">
            </div>
