                ...
                <div class="card shadow-lg border-0 rounded-lg mt-5">
                    <div class="card-header">
                        <h3 class="text-center font-weight-light my-4">
                            {{-- <a href="/admin"
                                ...
                                Back</a> --}}
                            <span class="mx-5 noselect">Create new Quotation</span>
                            {{-- <a href="/"
                    ...
                    <div class="card-body">
                        <form>
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        <div class="form-floating mb-1">
                                                                                ...
                                                                                <span class="text-danger">@error('subject')
                                                                                        {{ $message }}
                                                                                    @enderror</span>
                                                                                <label for="inputUserRole">Choose Subject</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        <div class="form-floating mb-1">
                                                                            ...
                                                                            <span class="text-danger">@error('date')
                                                                                    {{ $message }}
                                                                                @enderror</span>
                                                                            <label for="date">The Report Creation
                                                                                Date</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                            ...
                            <div class="mt-4 mb-0">
                                <div class="d-grid">
                                    <button wire:click.prevent="save()" class="btn btn-outline-success">Next</button>
                                </div>
                            </div>
                        </form>
                    </div>
