                        ...
                        <div class="col-lg-12">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <div class="card-header">
                                    <div class="row">
                                        <h3 class="text-center font-weight-light my-4 noselect">Items</h3>
                                    </div>
                                    <div class="results">
                                ...
                                <div class="card-body">
                                                ...
                                                <div class="col-12">
                                                    <div class="card-body">
                                                        @forelse ($items as $item)
                                                            @if (!isset(session()->get('cart', [])[$item->item_id]) && session()->get('cart', []) != 'info')
                                                                            ...
                                                                            <div class="media">
                                                                                <div class="media-body text-right">
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div class="col-4 noselect">
                                                                                            @if (!isset(session()->get('cart', [])[$item->item_id]))
                                                                                                <button type="button"
                                                                                                    class="btn btn-outline-info"
                                                                                                    wire:click.prevent="select({{ $item->item_id }})">Select</button>
                                                                                            @else
                                                                                                <button type="button"
                                                                                                    class="btn btn-outline-danger"
                                                                                                    wire:click.prevent="Unselect({{ $item->item_id }})">UnSelect</button>
                                                                                            @endif
                                                                                            <br />
                                                                                        </div>
                                                                                    </div>
                                                    ...
                                                    <div wire:ignore.self class="modal fade" id="CreateuserModal"
                                                        tabindex="-1" aria-labelledby="CreateuserModallabel"
                                                        aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title" id="CreateuserModalText">
                                                                        Create New Item
                                                                    </h5>
                                                                    <button type="button" class="btn-close"
                                                                        data-bs-dismiss="modal" aria-label="Close"
                                                                            ...
                                                                            <form autocomplete="off" method="POST">
                                                                                ...
                                                                                <div class="row mb-3">
                                                                                    <div class="col-6 col-md-6">
                                                                                        <button type="button"
                                                                                            class="btn btn-outline-success"
                                                                                            wire:click.prevent="addSearchName()">Add
                                                                                            The Search Name</button>
                                                                                    </div>
                                    ...
                                    <hr>
                                    <div class="row">
                                        <h4 class="text-center font-weight-light my-4 noselect">Selected Items</h4>
                                    </div>
                                    <div class="row">
                                        <div class=" col-12">
                                            <div class="card-body table-responsive">
                                                @if (session()->get('cart'))
                                                    @forelse (array_keys(session()->get('cart')) as $key)
                                                        <div class="Scard card shadow-lg border-2 rounded-lg">
                                                            <div class="card-content">
                                                                <div class="card-body">
                                                                    <div class="media">
                                                                        <div class="media-body text-right">
                                                                            <div class="row">
                                                                                <div class="col-6 col-md-2  noselect">
                                                                                    {{ session()->get('cart')[$key]['name'] }}
                                                                                </div>
                                                                                @if (!is_null(session()->get('cart')[$key]['price']))
                                                                                    <div
                                                                                        class="col-6 col-md-2  noselect">
                                                                                        {{ session()->get('cart')[$key]['price'] }}
                                                                                        SAR
                                                                                        <span
                                                                                            class="text-danger">@error('price')
                                                                                                {{ $message }}
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <button type="button"
                                                                                        class="btn btn-outline-danger"
                                                                                        wire:click.prevent="Unselect({{ $key }})">UnSelect</button>
                                                                                    <br />
                                                                                </div>
                                                                            </div>
                                                                        </div>
            ...
            @else
                <div class="container-fluid">
                    <div class="row justify-content-center mx-2">
                        <div class="col-lg-12">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                <h1 class="text-center text-capitalize m-5">There is no information go write
                                    some</h1>
