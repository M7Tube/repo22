...
<body>
    ...
    <div class="container">
        ...
        {{-- @forelse ($data[0]['signture'] as $Signkey =>$sign)
            <div class="col-xs-5 text-center">
                <img src="data:image/png|jpg|jpeg;base64, {!! base64_encode(file_get_contents('../public/upload/' . $sign)) !!}" style="height: auto; width: 500px;">
            </div>
        @empty
        @endforelse --}}
    </div>
